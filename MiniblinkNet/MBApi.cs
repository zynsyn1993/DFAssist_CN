...
namespace Kyozy.MiniblinkNet
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void wkePaintUpdatedCallback(IntPtr webView, IntPtr param, IntPtr hdc, int x, int y, int cx, int cy);
    ...
    internal class MBApi
    {
        ...
        public static extern void wkeVisitAllCookie(IntPtr usetData, wkeCookieVisitor visitor);
        ...
        [DllImport("node.dll", EntryPoint = "wkeSetDeviceParameter", CallingConvention = CallingConvention.Cdecl)]
